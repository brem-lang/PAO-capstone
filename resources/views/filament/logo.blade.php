@guest
    <img id="logo-img" src="{{ asset('/images/logo.png') }}" alt="logo"
        style="height: 70px;position:relative;margin-top: -25px;">

    <span style="font-weight:bold;font-size:14px;margin-left:5px;margin-top:1px">Public Attorney's Office</span>
@endguest
@auth
    <img id="logo-img" src="{{ asset('/images/logo.png') }}" alt="logo"
