            ...
            <ol class="statement">
                <li>
                    ...
                    <span class="underline-container">
                        <span class="text-above">_______________________</span>
                        <span class="text-below">(Relationship)</span>
                    </span>
                    of
                    <span class="underline-container">
                        <span class="text-above">________________________</span>
                        <span class="text-below">(Name of the owner)
                        </span>
                    </span>
                    a holder of
                    <span class="underline-container">
                        <span class="text-above">________________________________________________</span>
                ...
                <li>
                    That I am executing this affidavit to appraise the authorities concerned on the veracity of the
                    foregoing facts
