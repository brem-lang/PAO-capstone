...
<body>
    <div>
        ...
        <div class="content">
            ...
            <ol class="statement">
                <li>
                    That I am a holder of IDENTIFICATION CARD issued by
                    <span>_________________________________________________________</span>;
                </li>
                <li>
                    That the aforementioned IDENTIFICATION CARD was lost and/ or misplaced
                    and despite diligent effort to locate it the same could no longer be found;
                </li>
                <li>
