            ...
            <ol class="statement">
                <li>
                    ...
                    <div class="checkbox-container">
                        <label>
                            <input type="checkbox" name="documents[]" value="School ID">
                            School Identification Card
                        </label>
                        <label>
                            <input type="checkbox" name="documents[]" value="Library Card">
                            Library Card
                        </label>
                        <label>
                            <input type="checkbox" name="documents[]" value="Textbooks">
                            Textbook/s
                        </label>
                        <label>
                        ...
                        <label>
                            <input type="checkbox" name="documents[]" value="Form 138">
                            Form 138
                        </label>
                        <label>
                            <input type="checkbox" name="documents[]" value="Blue/White Card">
                            Blue Card/White Card
                        </label>
                        <label>
                            <input type="checkbox" name="documents[]" value="Solicitation Form">
                            Solicitation Form/s
                        </label>
                        <label>
                            <input type="checkbox" name="documents[]" value="Certificate of Registration">
                            Certificate of Registrations (COR)
                        </label>
                        <label>
                            <input type="checkbox" name="documents[]" value="NCAE">
                            National Career Assessment Examination (NCAE)
                        </label>
                        <label>
                            <input type="checkbox" name="documents[]" value="Transcript of Records">
                            Transcript of Records
                        </label>
                        <label>
                            <input type="checkbox" name="documents[]" value="JHS Diploma">
                            Junior High School Diploma
                        </label>
                        <label>
                            <input type="checkbox" name="documents[]" value="SHS Diploma">
                            Senior High School Diploma
                        </label>
                        <label>
                            <input type="checkbox" name="documents[]" value="College Diploma">
                            College Diploma
                        </label>
                        <label>
                            <input type="checkbox" name="documents[]" value="NC II">
                ...
                <li>
                    Under the circumstances, my said document/s can no longer be found, hence,
                    may now be considered lost for all legal intents and purposes;
                </li>
                <li>
