            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                ...
                <tr>
                    <td valign="middle" class="hero bg_white" style="padding: 20px">
                        ...
                        <h3 style="font-size: 15px">You can now <b> Change your Password </b> just click the
                            link below.
                        </h3>

                        <a href="{{ env('APP_URL') }}/app/password-reset/request?enableReset={{ $encryptedEmail }}">
                            {{ env('APP_URL') }}/app/password-reset/request
                        </a>
